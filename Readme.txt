...
How to run the project: The user should run the project file, it is the only python file with the game. 
You should put all the sounds in a folder called sounds. 
Put all the pictures such as jpg, png, gif, jpeg in a folder called Pics. 
Once you have done that, put the python file code, sounds, and Pics in 
1 folder named as you like and enjoy
